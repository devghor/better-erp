  ...
  return (
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Authentication by Auth.js</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
            ...
            to handle user authentication. Sign-up, sign-in, and password hashing are performed
            with a credentials-based demo user store — see{' '}
            <a
              href='https://authjs.dev/getting-started/security'
              target='_blank'
              rel='noopener noreferrer'
              className='text-primary font-medium hover:underline'
            >
              Auth.js&apos;s security documentation
            </a>{' '}
            for details on how it processes session data.
          </p>
        </section>
