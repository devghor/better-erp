...
- **[docs/nav-rbac.md](./docs/nav-rbac.md)** — Navigation RBAC: session-based role access control
- **[docs/auth_setup.md](./docs/auth_setup.md)** — Auth.js (NextAuth) Credentials setup: demo login, mock user store, swapping in a real backend
