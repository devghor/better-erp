...
- Auth - [Auth.js (NextAuth)](https://authjs.dev) with a Credentials provider
...
- Authentication via Auth.js (NextAuth) with a Credentials provider and an in-memory demo user store
- Client-side RBAC navigation that filters menu items by session role
...
| Page                                                                                                                                                                  | Notes                                                                                                                                                                                |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Signup / Signin                                                                                                                                                       | Credentials sign-in/sign-up via Auth.js, backed by an in-memory demo user store (`demo@example.com` / `demo12345`).                                                                 |
...
| [Profile](https://shadcn-dashboard.kiranism.dev/dashboard/profile)                                                                                                   | Displays the signed-in session user's name, email, and role.                                                                                                                        |
...
│   └── api/                       # API routes (incl. auth/[...nextauth])
│
...
For details on the Auth.js Credentials setup, demo login, and swapping in a real backend, see [auth_setup.md](./docs/auth_setup.md).
...
To strip out features you don't need (kanban, chat, notifications, extra themes, Sentry), run the cleanup script:
